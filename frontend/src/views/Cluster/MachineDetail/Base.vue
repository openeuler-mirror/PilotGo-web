<template>
    <div class="content">
        <el-descriptions :column="2" border>
            ...
            <el-descriptions-item label="系统版本"> {{ machineInfo.platform + ' ' + machineInfo.platform_version }} </el-descriptions-item>
            <el-descriptions-item label="架构"> {{ machineInfo.kernel_arch }} </el-descriptions-item>
            <el-descriptions-item label="cpu"> {{ machineInfo.cpu_num + '核 ' + machineInfo.model_name }} </el-descriptions-item>
            <el-descriptions-item label="内存"> {{ (machineInfo.memory_total / 1024 / 1024).toFixed(2) + 'G' }} </el-descriptions-item>
